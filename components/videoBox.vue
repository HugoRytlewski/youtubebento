...
const { titre, chaine , nombre_vues ,logo_chaine ,miniature,date_sortie,temps} = defineProps({
    titre: String,
    chaine: String,
    nombre_vues: Number,
    logo_chaine: String,
...
<template>
  <div class="flex items-center justify-center group"> 
    ...
    <div
        class="relative w-[292px] ml-[24px] rounded-xl h-[250px] overflow-hidden z-50 group-hover:scale-105 duration-300 "
      >
        ...
        <div class="h-[164px] overflow-hidden relative bg-red-600 ">
          ...
          />
          <div
            class="z-50 absolute bottom-2 right-2 p-2 h-[16px] text-white bg-black bg-opacity-75 rounded-full text-center flex items-center justify-center group-hover:opacity-0 duration-200"
          >
            <p class="text-[12px] ">{{ temps }}</p>
          </div>
        </div>
